...
@Slf4j
@Component
public class CourseBailianAgent implements BaseAgent {

    private final DashScopeAgent agent;
    private final List<String> keywords;

    @Value("${spring.ai.dashscope.agent.course-app-id}")
    private String appId;

    public CourseBailianAgent(DashScopeAgentApi dashscopeAgentApi) {
    ...
    public String getAgentName() {
        return "CourseBailianAgent";
    }

    @Override
    public String getDescription() {
        return "课程智能体，处理课程表查询和教室信息";
    }
}
